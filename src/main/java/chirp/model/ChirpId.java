...
/**
 * Entity representing a chirp id. This isn't much more than a wrapper class for a String.
 */
public class ChirpId implements Comparable<ChirpId>, Serializable {
    ...
    private static final AtomicLong baseId = new AtomicLong(System.currentTimeMillis());
    ...
    public boolean equals(Object obj) {
        ...
        final ChirpId other = (ChirpId) obj;
        if (id == null) {
            if (other.id != null) {
                return false;
            }
